  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        // UI is the field role, the same as Input. `field-sizing-content`
        // grows the box with what is typed, so the drag handle would only
        // duplicate that and it is turned off.
