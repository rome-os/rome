...
export const WIDE_ACTIVE_CLASS = "bg-surface shadow-1 dark:bg-surface-hover";
export const WIDE_IDLE_CLASS = "hover:bg-surface-hover dark:hover:bg-surface";
...
export const RAIL_ACTIVE_CLASS = "bg-surface shadow-1 dark:bg-surface-hover";
export const RAIL_IDLE_CLASS = "hover:bg-surface-hover dark:hover:bg-surface";
