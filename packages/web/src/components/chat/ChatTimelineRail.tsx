                  ...
                  <Tooltip key={node.messageId}>
                    ...
                    tabbable. */}
                      <button
                        ...
                        className="pointer-events-auto absolute left-4 size-3.5 -translate-x-1/2 -translate-y-1/2 rounded-full before:absolute before:top-1/2 before:left-1 before:h-0.5 before:w-2 before:-translate-y-1/2 before:origin-left before:rounded-full before:scale-x-100 before:bg-muted-foreground before:opacity-40 before:transition-[opacity,scale] before:duration-200 before:ease-out motion-reduce:before:transition-none group-hover:before:opacity-70 hover:before:scale-x-150 hover:before:opacity-100 outline-1 outline-offset-0 outline-transparent focus-visible:outline-solid focus-visible:outline-ring/50 focus-visible:before:scale-x-150 focus-visible:before:opacity-100"
                      />
                    </TooltipTrigger>
